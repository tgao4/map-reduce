...
public class UnitSum {
    public static class PassMapper extends Mapper<Object, Text, Text, DoubleWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            double subRank = Double.parseDouble(line[1]);
            context.write(new Text(line[0]), new DoubleWritable(subRank));
        }
    }
    ...
    public static class BetaMapper extends Mapper<Object, Text, Text, DoubleWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String[] line = value.toString().split("\t");
            double weight = Double.parseDouble(line[1]) * beta;
            context.write(new Text(line[0]), new DoubleWritable(weight));
        }
    }
